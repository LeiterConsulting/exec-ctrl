...
Published-source lab rerun, hosted CI and final remote identity verification are
pending. Previous evidence remains in [the first controlled report](V2_CONTROLLED_LAB_RESULTS.md).
